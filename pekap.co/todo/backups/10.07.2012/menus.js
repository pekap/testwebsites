	    ...
	    loader=$.post("index.php",{tid:nnm,cid:nm},function(data){
                if(data){	          
                    ...
                    if (data.cid!=0){
                        ...
                        s="<div id='name_"+nnm+"' class='todo-entry'>"+
                                                        "<table class='thentr'>"+
                                                                "<tr>"+
                                                                ...
                                                                "</tr>"+
                                                        "</table>"+
                                                        "<div class='properties'><div class='el-cat'><a name='"+data.cid+"' id='categ_top_"+nnm+"' class='categ closed'>"+data.n+"</a><div class='menus' id='menu_"+nnm+"'><table>";
                        $obj=$("#names"+data.cid);
                        for ( var i in data.cat_array){
                                ...
                                s=s+"<tr>"+
                                             "<td>"+
                                             "<a name='"+nnm+"' id='cat_menu_"+ci+"'>"+cnm+"</a>"+
                                             "</td>"+
                                             "</tr>";
                        }
